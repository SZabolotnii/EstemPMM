...
required_packages <- c("EstemPMM", "ggplot2", "moments", "tseries",
                       "gridExtra", "RColorBrewer", "tidyr", "dplyr")
...
cat("  cat analysis/results/ANALYTICAL_REPORT.md\n\n")

cat("  # View results in R\n")
cat("  results <- readRDS('analysis/results/all_results.rds')\n")
cat("  View(results)\n\n")

cat("  # Convert report to HTML\n")
cat("  pandoc analysis/results/ANALYTICAL_REPORT.md \\\n")
cat("    -o analysis/results/ANALYTICAL_REPORT.html \\\n")
cat("    -s --toc --toc-depth=3 \\\n")
cat("    --metadata title='ARIMA Comparison Study'\n\n")

cat("  # Convert report to PDF (requires LaTeX)\n")
cat("  pandoc analysis/results/ANALYTICAL_REPORT.md \\\n")
cat("    -o analysis/results/ANALYTICAL_REPORT.pdf \\\n")
cat("    -s --toc --toc-depth=3\n\n")
...
cat("For detailed analysis, see: analysis/results/ANALYTICAL_REPORT.md\n\n")
