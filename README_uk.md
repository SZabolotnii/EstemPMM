...
## Варіанти PMM2 (версія 0.2.0)

Пакет пропонує **три варіанти реалізації PMM2**, оптимізовані для різних ситуацій:

### 1. Unified Global (рекомендовано за замовчуванням)

```r
ar_pmm2(y, order = 2, pmm2_variant = "unified_global")  # за замовчуванням
```

**Характеристики:**
- ✅ Одноразова корекція після класичного оцінювання (MLE/CSS)
- ✅ Швидкий (~50% швидше за ітеративний)
- ✅ Стабільний для всіх типів моделей
- ✅ Покращення MSE на 3-23% (за Monte Carlo R=50)

**Коли використовувати:** Для більшості застосувань, коли потрібна найкраща комбінація швидкості та точності.

### 2. Unified Iterative (максимальна точність)
...
**Характеристики:**
- ✅ Повна ітеративна процедура Ньютона-Рафсона
- ✅ Найвища точність (покращення MSE до 23%)
- ✅ Автоматичний чисельний Якобіан (через `numDeriv`)
- ⚠️ Повільніший за один крок

**Коли використовувати:** Коли точність критична, а час обчислень не є проблемою.

### 3. Linearized (спеціаліст для MA/SMA)
...
**Характеристики:**
- ✅ Спеціалізований лінійний підхід для MA/SMA моделей
- ✅ Оптимальна ефективність для чистих MA моделей (покращення MSE на 21-44%)
- ✅ Швидка збіжність (3-5 ітерацій)
- ⚠️ Працює тільки для MA/SMA моделей

**Коли використовувати:** Для чистих MA(q) або SMA(Q) моделей з асиметричними інноваціями.

### Порівняння варіантів (Monte Carlo R=50, n=200)

| Модель | Unified Global | Unified Iterative | Linearized | Найкращий |
|--------|----------------|-------------------|------------|-----------|
...
**Висновок:** 
- Unified Global — найкращий універсальний вибір (за замовчуванням)
- Unified Iterative — для максимальної точності
- Linearized — оптимальний для MA/SMA моделей
