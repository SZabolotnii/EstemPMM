    ...
    if (use_ma_pmm2) {
      ...
      if (p == 0 && P == 0) {
        if (q > 0 && Q == 0) {
          ...
          # Mixed MA + SMA or other combinations - fallback to standard PMM2 (hybrid)
          if (verbose) cat("  Mixed MA+SMA not yet fully supported in pure PMM2 mode, falling back to standard hybrid approach.\n")
        }
      } else {
