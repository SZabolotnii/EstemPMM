...
fit_sar_pmm2 <- sar_pmm2(y, order = 1, seasonal_order = 1,
                         seasonal_period = 12, method = "pmm2")

# Compare with OLS
fit_sar_ols <- sar_pmm2(y, order = 1, seasonal_order = 1,
                        seasonal_period = 12, method = "ols")
...
fit_sma_pmm2 <- sma_pmm2(y, order = 1, seasonal_period = 4, method = "pmm2")

# Fit with CSS for comparison
fit_sma_css <- sma_pmm2(y, order = 1, seasonal_period = 4, method = "css")
...
compare_sar_methods(y, order = 1, seasonal_order = 1, seasonal_period = 12)

# Universal comparison for any time series model
compare_ts_methods(y, model_type = "sar",
                   order = 1, seasonal_order = 1,
                   seasonal_period = 12)
```
